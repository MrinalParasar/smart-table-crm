...
export function DataTable({
  ...
  const getFrozenColumnLeft = (fieldIndex: number) => {
    let left = 56; // Row number column width
    for (let i = 0; i < fieldIndex; i++) {
      left += 160; // Each column width
    }
    return left;
  };
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      {/* Table */}
      <div className="flex-1 overflow-hidden border-t border-table-border">
        <div className="h-full overflow-auto">
          <table className="border-collapse" style={{ minWidth: 'max-content' }}>
            <thead>
              <tr className="bg-table-header sticky top-0 z-20 border-b border-table-border">
                <th className="w-14 px-3 py-3 border-r border-table-border/50 sticky left-0 bg-table-header z-30 shadow-[2px_0_4px_-2px_rgba(0,0,0,0.1)]"></th>
                {table.fields.map((field, fieldIndex) => {
                  ...
                  const leftOffset = isFrozen ? getFrozenColumnLeft(fieldIndex) : undefined;
                  ...
                  return (
                    <th
                      ...
                      className={cn(
                        ...
                        isFrozen && "sticky bg-table-header z-20 shadow-[2px_0_4px_-2px_rgba(0,0,0,0.1)]"
                      )}
            ...
            <tbody>
              {filteredRecords.map((record, index) => (
                ...
                >
                  <td className="px-3 py-2 border-r border-table-border/50 text-center sticky left-0 bg-background z-10 shadow-[2px_0_4px_-2px_rgba(0,0,0,0.05)]">
                    ...
                    return (
                      <td
                        ...
                        className={cn(
                          ...
                          isFrozen && "sticky bg-background z-10 shadow-[2px_0_4px_-2px_rgba(0,0,0,0.05)]"
                        )}
                        style={isFrozen ? { left: `${leftOffset}px` } : undefined}
                      >
                        <EditableCell
